...
import { BarangManualRoutingModule } from "./barangrouting";
...
@NgModule({
  declarations: [
    BarangManualBrowseComponent,
    BarangManualInputComponent,
    TabelDetilLainLainComponent,
    DetilLainLainInputComponent,
  ],
  entryComponents: [DetilLainLainInputComponent, InfoCustomerComponent],
  imports: [
    FormsModule,
    CommonModule,
    ReactiveFormsModule,
  ...
  exports: [BarangManualInputComponent],
  providers: [
